...
run('SoloA_ALL_CuriusHuman_FullPath.m');               %% run the script to have the path for each session data
...
file1_name = 'SoloACurius_AllSess_MeanRT.svg';
file2_name = 'SoloACurius_AllSess_ViolinRT.svg';
