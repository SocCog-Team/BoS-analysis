...
for fol = 1:length(MonkeyFoldersName)
    ...
    for idata = 1 : length(MergedData)
        ...
        if numel(SelfOther_NotValidSwitchId) == 2
            ANotValidSwitchID_SelfOther =  SelfOther_NotValidSwitchId{1};
            BNotValidSwitchID_SelfOther = SelfOther_NotValidSwitchId{2};
        else
            if ~isempty(SelfOther_NotValidSwitchId{1})
                ANotValidSwitchID_SelfOther =  SelfOther_NotValidSwitchId{1}
                BNotValidSwitchID_SelfOther = []
            end
            if ~isempty(SelfOther_NotValidSwitchId{2})
                ANotValidSwitchID_SelfOther = []
                BNotValidSwitchID_SelfOther = SelfOther_NotValidSwitchId{2};
            end
        end
        ...
        if numel(OtherSelf_NotValidSwitchId) == 2
            ANotValidSwitchID_OtherSelf =  OtherSelf_NotValidSwitchId{1};
            BNotValidSwitchID_OtherSelf = OtherSelf_NotValidSwitchId{2};
        else
            if ~isempty(OtherSelf_NotValidSwitchId{1})
                ANotValidSwitchID_OtherSelf =  OtherSelf_NotValidSwitchId{1};
                BNotValidSwitchID_OtherSelf = [];
            end
            if ~isempty(OtherSelf_NotValidSwitchId{2})
                ANotValidSwitchID_OtherSelf = [];
                BNotValidSwitchID_OtherSelf = OtherSelf_NotValidSwitchId{2};
            end
        end
    ...
    for idata = 1 : length(MergedData)
        ...
        for Turn = 1 : 3
            if Turn == 1
                ...
                hold on
                %                 %% blue curve
                plot(1:BeforeAfter_Length+1+BeforeAfter_Length,MeanOverSessAtSwitch_MeanSelfOther(Turn,:,1),'.-','Color',ActorAcolor,'LineWidth',4)
                ...
                hold on
                %                 %% blue curve
                plot(1:BeforeAfter_Length+1+BeforeAfter_Length,MeanOverSessAtSwitch_MeanOtherSelf(Turn,:,1),'.-','Color',ActorAcolor,'LineWidth',4)
        ...
        SessionDate = string(AllDates_NotRepeat{idata})
        sgtitle(strcat('Pair: ',sprintf(A_Name),', ',sprintf(B_Name),SessionDate,',RT range: 100ms'))
        ...
        for Turn = 1 : 3
            if Turn == 1
                ...
                hold on
                %                 %% blue curve
                plot(1:BeforeAfter_Length+1+BeforeAfter_Length,MeanOverSessAtSwitch_MeanSelfOther(Turn,:,2),'.-','Color',ActorBcolor,'LineWidth',4)
                %
                ...
                hold on
                %                 %% blue curve
                plot(1:BeforeAfter_Length+1+BeforeAfter_Length,MeanOverSessAtSwitch_MeanOtherSelf(Turn,:,2),'.-','Color',ActorBcolor,'LineWidth',4)
