        ...
        if length(BeforeShedding)>1
            for i_struct = 1 : length(BeforeShedding)
                ...
                if i_struct == 1
                    ...
                    RewardedTrialsLogicalIdx = TransientData.FullPerTrialStruct.TrialIsRewarded;
                    CurrentPreviouslyRewardedIDXnum = find(RewardedTrialsLogicalIdx(2:end) & RewardedTrialsLogicalIdx(1:end-1))+1
                    ...
                    RewardedANDdyadicTrialId = intersect(RewardedANDdyadicTrialId,CurrentPreviouslyRewardedIDXnum);
