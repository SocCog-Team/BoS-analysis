...
for fol = 1 :length(ConditionFoldersName)
    clearvars -except RT_ToleranceThreshold ConditionFoldersName calcSEM ActorAcolor ActorBcolor ActorBAtSwitchCol ActorAatSwitchCol starting_dir fol MainLineWidth
    ...
    for idata = 2 % 1 : NumberOfTimePoints
        ...
        if idata == 2
            filename = []
            filename = strcat(A_Name,'-3out5-',B_Name,'.pdf')
            filenameSCABLE = []
            filenameSCABLE = strcat(A_Name,'-3out5-',B_Name)
            ax = gcf;
        ...
        if idata == 2
            filename = []
            filename = strcat(A_Name,'-3out5-',B_Name,'Bswitch.pdf')
            filenameSCABLE = []
            filenameSCABLE = strcat(A_Name,'-3out5-',B_Name,'Bswitch')
            ax = gcf;
            exportgraphics(ax,sprintf(filename),'Resolution',600)
            print(ax,sprintf(filenameSCABLE), '-dsvg','-r600');
        end
