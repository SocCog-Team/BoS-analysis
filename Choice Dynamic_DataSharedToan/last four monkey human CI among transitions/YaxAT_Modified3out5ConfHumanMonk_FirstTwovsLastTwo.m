...
for fol = 3 %1 :length(ConditionFoldersName)
    ...
    for idata = 2%1 : NumberOfTimePoints
        ...
        for AC = 1 : 2
            for Turn = 1 : 3
                NeededSwitchVector = AllSubj_AT(AC,:)';
    ...
    for idata = 2 % 1 : NumberOfTimePoints
        ...
        figure('Name',sprintf(FigName), 'NumberTitle', 'off','Position',[488,49.80000000000001,653,732.8000000000002])
        for Turn = 1 : 3
            if Turn == 1
                subplot(3,2,1)
                hold on
                ...
                title(strcat('subj first,',sprintf(A_Name),' : switcher own to other'))
                OveralSwitch = []
                ...
                title(strcat('subj first,',sprintf(A_Name),' : switcher other to own'))
                OveralSwitch = []
            ...
            if Turn == 2
                ...
                title(strcat('simul,',sprintf(A_Name),' : switcher own to other'))
                OveralSwitch = []
                OveralSwitch = SelfOtherSwitchNum(Turn,1);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
                ...
                title(strcat('simul,',sprintf(A_Name),' : switcher other to own'))
                OveralSwitch = []
                OveralSwitch = OtherSelfSwitchNum(Turn,1);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
            ...
            if Turn == 3
                ...
                title(strcat('subj second,',sprintf(A_Name),' : switcher own to other'))
                OveralSwitch = []
                OveralSwitch = SelfOtherSwitchNum(Turn,1);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
                ...
                title(strcat('subj second,',sprintf(A_Name),' : switcher other to own'))
                OveralSwitch = []
                OveralSwitch = OtherSelfSwitchNum(Turn,1);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
        ...
        if idata == 1
            ...
            sgtitle(strcat('Pair: ',sprintf(A_Name),', ',sprintf(B_Name),' four last sessions',',AT range: 100ms,3/5'))
        end
        ...
        if idata == 2
            filename = []
            filename = strcat(A_Name,'-3out5-yAT-',B_Name,'.pdf')
            filenameSCABLE = []
            filenameSCABLE = strcat(A_Name,'-3out5-yAT-',B_Name)
            ax = gcf;
        ...
        for Turn = 1 : 3
            if Turn == 1
                ...
                title(strcat('subj second,',sprintf(B_Name),' : switcher own to other'))
                OveralSwitch = []
                ...
                title(strcat('subj second,',sprintf(B_Name),' : switcher other to own'))
                OveralSwitch = []
            ...
            if Turn == 2
                ...
                title(strcat('simul,',sprintf(B_Name),'switcher own to other'))
                OveralSwitch = []
                OveralSwitch = SelfOtherSwitchNum(Turn,1);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
                ...
                title(strcat('simul,',sprintf(B_Name),' : switcher other to own'))
                OveralSwitch = []
                OveralSwitch = OtherSelfSwitchNum(Turn,2);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
            ...
            if Turn == 3
                ...
                title(strcat('subj first,',sprintf(B_Name),' : switcher own to other'))
                OveralSwitch = []
                OveralSwitch = SelfOtherSwitchNum(Turn,2);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
                ...
                OveralSwitch = OtherSelfSwitchNum(Turn,2);
                subtitle(strcat('Switch Num: ',string(OveralSwitch)))
                title(strcat('subj first,',sprintf(B_Name),' : switcher other to own'))
                set(gca, 'XColor', 'none'); % Make x-axis invisible
                if OveralSwitch == 0
                    % Find and delete all lines
                    hPlots = findobj(gca, 'Type', 'line');
        ...
        if idata == 2
            filename = []
            filename = strcat(A_Name,'-3out5-yAT-',B_Name,'Bswitch.pdf')
            filenameSCABLE = []
            filenameSCABLE = strcat(A_Name,'-3out5-yAT-',B_Name,'Bswitch')
            ax = gcf;
            % exportgraphics(ax,sprintf(filename),'Resolution',600)
            % print(ax,sprintf(filenameSCABLE), '-dsvg','-r600');
        end
