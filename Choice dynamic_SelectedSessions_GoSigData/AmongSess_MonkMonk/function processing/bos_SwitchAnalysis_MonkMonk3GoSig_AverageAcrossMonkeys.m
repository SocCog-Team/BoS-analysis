...
baseFunctDir = 'C:\Users\zahra\OneDrive\Documents\PostDoc_DPZ\Zahra codes';
...
for fol = 1 :length(ConditionFoldersName)
    ...
    [MergedData,MatFile_ActorBgotA_IndexNumber,CS,ACTORA,ACTORB,SessionDate,FirstSessActorA,FirstSessActorB] = MergingSplittedSessions_GoSigData(scriptName,StartingDir,OpenedConditionFoldersName);
    Results_CoreProcessing3of5ChoiceDynamic_GoSigDataSet = CoreProcessing3of5ChoiceDynamic_GoSigDataSet(scriptName,MergedData,AT_ToleranceThreshold,MatFile_ActorBgotA_IndexNumber);
