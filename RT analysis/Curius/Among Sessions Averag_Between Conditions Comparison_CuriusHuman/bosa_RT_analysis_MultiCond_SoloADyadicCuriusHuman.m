...
title('Mean RT of Curius in sessions 2023 with Dyadic and SoloA conditions')
...
ylim([400 700])
title('RT of Curius among sessions 2023 with Dyadic and SoloA')
subtitle(subtitle_Text)
fig2 = gcf;
...
file1_name = 'MultiCondDyadicSoloCurius_AllSess_MeanRT.pdf';
exportgraphics(fig1,sprintf(file1_name),'Resolution',600);

file2_name = 'MultiCondDyadicSoloCurius_AllSess_ViolinRT.pdf';
exportgraphics(fig2,sprintf(file2_name),'Resolution',600);

% saveas(fig1, file1_name, 'svg');
% saveas(fig2, file2_name, 'svg');

% save('Curius_RTDyadic','Mean_RTDyadic_SoloADyadicSessions')
% save('Curius_RTSolo','Mean_RTSoloA_SoloADyadicSessions')
