...
for fol = 1:length(ConditionFoldersName)
 ...
 TrialsVector = (1 : size(HistoryVector,1))';
        ...
        for AC = 1:2
            ...
            ChoiceHistoryCoefs{AC}(:,idata) = double(SelChoiceHistory_PartnerChoiceHistyory_Model.Coefficients(2:end,2));
            ChoiceHistoryGoodnessOfFit{AC}(idata,:) = double(SelChoiceHistory_PartnerChoiceHistyory_Model.Coefficients(2:end,6));
