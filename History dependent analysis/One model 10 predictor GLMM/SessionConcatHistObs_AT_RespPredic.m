...
for fol = 1:length(ConditionFoldersName)
    ...
    for AC = 1:2
        ...
        ChoiceHisObservedHistGoodnessOfFit_R2(fol,AC) = SelFChoiceHist_PartnerChoiceHist_ObservedHist_Model.Rsquared.Adjusted;
        ...
        if AC == 1
            subtitle(strcat(A_Name,' R2= ',string( round(ChoiceHisObservedHistGoodnessOfFit_R2(fol,AC),1))))
        else
            subtitle(strcat(B_Name,' R2= ',string( round(ChoiceHisObservedHistGoodnessOfFit_R2(fol,AC),1))))
