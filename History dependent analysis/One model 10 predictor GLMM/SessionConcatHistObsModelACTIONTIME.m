...
for fol = 2%1:length(ConditionFoldersName)
    nexttile, hold on
    ...
    for AC = 1 : 2
        ...
        MeanAcrossSessChoiceHistoryGoodnessPval{fol}(:,AC) =   ChoiceHisObservedHistGoodnessOfFit(:,AC);
    ...
    for AC = 1 : 2
        if AC == 1
            ...
            % ylim([-4 4])
             ...
             StarFilterSelf =   MeanAcrossSessChoiceHistoryGoodnessPval{fol}(1,AC)<0.05;
            if sum(StarFilterSelf)~= 0
             ...
             StarFilterOther =   MeanAcrossSessChoiceHistoryGoodnessPval{fol}(2,AC)<0.05;
            if sum(StarFilterOther)~= 0
             ...
             StarFilterObserved =   MeanAcrossSessChoiceHistoryGoodnessPval{fol}(3,AC)<0.05;
            ...
            yaxisINTERACT = MeanAcrossSessChoiceHistoryCoefs{AC}(4);
             StarFilterINTERACT =   MeanAcrossSessChoiceHistoryGoodnessPval{fol}(4,AC)<0.05;
        ...
        subtitle(strcat('R2= ',string(round(MeanAcrossSessChoiceHistoryGoodnessR2{fol}(1),3)),' ,',string(round(MeanAcrossSessChoiceHistoryGoodnessR2{fol}(2),3))))
