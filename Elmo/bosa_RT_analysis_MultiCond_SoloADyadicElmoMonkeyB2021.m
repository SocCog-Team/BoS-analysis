function [Mean_RTDyadic_SoloADyadicSessions,SD_RTDyadic_SoloADyadicSessions ] = bosa_RT_analysis_MultiCond_SoloADyadicElmoMonkeyB2021
ColorFor_Dyadicplots = [0 153 153]./255;
ColorFor_SoloAplots = [128,0,128]./255;


 run('ElmoA_Monkey2021EphysDyadicSoloA_FullPath'); 

                      
bins = [0:25:1000]; %% Bin width for RT distribution
% FullSessPath = ElmoB_Human2023EphysFullSessionPath;
FullSessPath = ElmoA_Monkey2021EphysFullSessionPath
...
sgtitle('Session with only Dyadic between ElmoA and CuriusB, contains only Simult')
% fig0 = gcf;
%% plottig
