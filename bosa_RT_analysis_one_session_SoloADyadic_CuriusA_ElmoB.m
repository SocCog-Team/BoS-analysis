function [Statitical_Results] = bosa_RT_analysis_one_session_SoloADyadic_CuriusA_ElmoB(DataFileName)
...
sgtitle('Session with only Dyadic and Solo, (Monkey vs monkey)')
